...
module.exports = (function() {
	...
	return {
		...
		getClientIP: function(req) {
			// if private IP use default '80.168.92.194'
			return req.headers['True-Client-IP'] || req.headers['x-forwarded-for'] || (ip.isPrivate(req.connection.remoteAddress) ? '80.168.92.194' : req.connection.remoteAddress);
		},
